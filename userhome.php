...
echo $questd['title']." | Crypto</title>";
include_once("includes/header.php");

echo"
<div id=\"login\" style=\"width:50%;float:left;margin-left:35%\">
<h2> Question ".$questd['qno']." </h2><p>".$questd['mainq']."</p><br />";
if($questd['img']!="NULL")
	echo "<img src=\"photos/".$questd['img'].".jpg\" class=\"image\" align=\"middle\" /><br />";
echo "<!-- ".$questd['tagline']." -->";


echo "<p><form action='chkans.php' method='POST'>";
echo "<div align='center'><input type='text' class='textbox' name='ans' />&emsp;";
echo "<input type='submit' class='btn' value='Submit' /></div> <br />";
echo "<input type='hidden' name='level' value='$x' />";
